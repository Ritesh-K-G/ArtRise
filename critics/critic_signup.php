<?php
    ...
    if(empty($logname)){
        echo '<script>alert(" Enter Your Name");setTimeout(()=>{window.location.replace("index.html");},500);</script>';
        exit();
    }
    else if(empty($logemail)){
        echo '<script>alert(" Enter Your Email");setTimeout(()=>{window.location.replace("index.html");},500);</script>';
        exit();
    }
        ...
        echo '<script>alert(" Enter Your Qualification");setTimeout(()=>{window.location.replace("index.html");},500);</script>';
        exit();
    }
    else if(empty($logcontact)){
        echo '<script>alert(" Enter Your Contact");setTimeout(()=>{window.location.replace("index.html");},500);</script>';
        exit();
    }
    else{
        ...
        if($conn->query($sql) == true){
            echo '<script>alert(" Your are now a critic");setTimeout(()=>{window.location.replace("../index.html");},500);</script>';
        }
        else{
